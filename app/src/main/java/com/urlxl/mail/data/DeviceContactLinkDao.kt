...
interface DeviceContactLinkDao {
     ...
     *  unlinked and [com.urlxl.mail.contacts.device.DeviceContactRepository.pushRoomChangesToDevice]
     ...
     *  [com.urlxl.mail.contacts.device.DeviceContactRepository.deleteAllSyncedDeviceContacts]. */
