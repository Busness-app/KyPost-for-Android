...
class KeywordSettings(context: Context) {
    ...
    private val hostileLocationSettings = com.urlxl.mail.security.HostileLocationSettings(context)
    ...
    companion object {
        /** Public so [com.urlxl.mail.security.SecurityWipe] and
         *  [com.urlxl.mail.push.PushRepository.clearPairing] can clear this file by name rather
         *  than repeating the literal. */
        const val PREFS_NAME = "com.urlxl.mail.keyword_settings"
